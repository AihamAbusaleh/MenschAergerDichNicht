...
public class TUI implements IObserver {
	...
	public void display() {
		print("                                        ");
		print(" " + c.getTokenColorBlock(0, 0) + " " + c.getTokenColorBlock(0, 1) + IRIGHT + c.getTokenColor(38) + MIN
				+ c.getTokenColor(39) + "-" + c.getTokenColor(0) + ILEFT + c.getTokenColorBlock(1, 0) + " "
				+ c.getTokenColorBlock(1, 1) + " ");
		print("						|38-39-0|        ");
		print(" " + c.getTokenColorBlock(0, 2) + " " + c.getTokenColorBlock(0, 3) + IRIGHT + c.getTokenColor(37)
				+ ICENTER + c.getTokenColorHouse(1, 0) + ICENTER + c.getTokenColor(1) + ILEFT
				+ c.getTokenColorBlock(1, 2) + " " + c.getTokenColorBlock(1, 3) + " ");
		print("						|37    1|        ");
		print("    " + IRIGHT + c.getTokenColor(36) + ICENTER + c.getTokenColorHouse(1, 1) + ICENTER
				+ c.getTokenColor(2) + ILEFT);
		print("						|36    2|        ");
		...
		print(ICENTER + c.getTokenColor(29) + " " + c.getTokenColorHouse(0, 0) + " " + c.getTokenColorHouse(0, 1) + " "
				+ c.getTokenColorHouse(0, 2) + " " + c.getTokenColorHouse(0, 3) + "   " + c.getTokenColorHouse(2, 0)
				+ " " + c.getTokenColorHouse(2, 1) + " " + c.getTokenColorHouse(2, 2) + " " + c.getTokenColorHouse(2, 3)
				+ " " + c.getTokenColor(9) + ICENTER);
		print("				    |29                            09|");
		...
		print("		                	        |22    16|        ");
		print(" " + c.getTokenColorBlock(3, 0) + " " + c.getTokenColorBlock(3, 1) + IRIGHT + c.getTokenColor(21)
				+ ICENTER + c.getTokenColorHouse(3, 0) + "|" + c.getTokenColor(17) + ILEFT + c.getTokenColorBlock(2, 0)
				+ " " + c.getTokenColorBlock(2, 1) + " ");
		print("		                 	        |21    17|        ");
		print(" " + c.getTokenColorBlock(3, 2) + " " + c.getTokenColorBlock(3, 3) + IRIGHT + c.getTokenColor(20) + MIN
				+ c.getTokenColor(19) + MIN + c.getTokenColor(18) + ILEFT + c.getTokenColorBlock(2, 2) + " "
				+ c.getTokenColorBlock(2, 3) + " ");
		print("						|20-19-18|           \n");
